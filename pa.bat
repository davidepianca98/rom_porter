...
pause
echo.
echo  Put your PA ROM into Port-Rom
echo.
pause
echo.
...
echo  ro.modversion=
echo.
echo  Write this line in base of your screen resolution
echo   For mdpi   ro.pa.family=pa_mdpi
echo   For hdpi   ro.pa.family=pa_hdpi
echo   For xhdpi   ro.pa.family=pa_xhdpi
echo.
echo  Write this line replacing x.xx with the paranoid version
echo   ro.pa.version=x.xx
echo.
pause
cls
...
echo.
echo  Write this
echo  set_perm(1000, 1000, 0644, "/system/etc/paranoid/properties.conf");
echo.
...
echo.
echo Then copy the folder from %cd%\Port-Rom\port except system and META-INF
echo.
pause
goto mod
